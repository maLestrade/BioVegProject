...
public class RemotePrimerBlastNCBI {
  ...
  protected void processOptions(StringBuilder buf) throws UnsupportedEncodingException
  {
  ...
  protected String convertOptionToString(Object opt) throws UnsupportedEncodingException
  {
    if (opt == null) {
      return "";
    }
